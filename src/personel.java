   ...
   public giris parentt;
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(36, 36, 36)
                        .addComponent(kullanıcıadı, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)))
                .addGap(192, 192, 192))
    ...
    private void GirisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GirisActionPerformed
     ...
     try{ 
        ...
        users u=new users();
       ResultSet rs=st.executeQuery("select ukullaniciadi, usifre from users");
       String kAdi=kullanıcıadı.getText();
       String sfr=sifre.getText();
       while(rs.next()){
       if(kullanıcıadı.getText().equals(rs.getString("ukullaniciadi")) &&sifre.getText().equals(rs.getString("usifre"))){
